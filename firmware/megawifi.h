...
/// Firmware variant, "std" for standard ESP8266 version,
/// ec3 for standard ESP32-C3 version
#define MW_FW_VARIANT	"ec3"
...
// Audio subsystem commands (requires CONFIG_MW_AUDIO_ENABLE)
#define MW_CMD_AUD_PLAY			 59	///< Play MOD (data[0] = mod index)
#define MW_CMD_AUD_STOP			 60	///< Stop playback
#define MW_CMD_AUD_PAUSE		 61	///< Pause playback
#define MW_CMD_AUD_RESUME		 62	///< Resume playback
